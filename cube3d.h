...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/04 12:08:39 by ybazylbe          #+#    #+#             */
/*   Updated: 2025/08/04 12:15:04 by ybazylbe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_textured_wall(t_struct *game_struct, double wall_height,
...
double	get_texture_x_offset(t_struct *game, mlx_texture_t *texture);
...
int		ray_intersection(float *coord, int is_horizontal, float *step,
			float angle);
...
int		verify_file_integrity(t_struct *game_struct, char *file_path,
			char *filetype);
void	free_split(char **split);
void	free_graphics(t_struct *game_struct);
void	free_game_data(t_struct *game_struct);
bool	parse_rgb(char *str, int *rgb);
void	parse_texture_line(t_texture_data *texdata, char *line,
